...
public class FormGV extends javax.swing.JPanel {
    ...
    public FormGV() {
        initComponents();
        setSize(950,850);
        String[] cols={"Ma GV","Ten GV","dia chi","Trinh do"};
    ...
    private void btCapNhatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCapNhatActionPerformed
        ...
        if(them){
            ...
            try{
               ...
               if(ten.isEmpty()||dchi.isEmpty()) throw new TrongException();
               int ma=Integer.parseInt(jTextField1.getText());
               GiangVien b=new GiangVien(ma,ten,dchi,jComboBox1.getSelectedItem().toString());
        ...
        if(sua){
            ...
            String trdo=jComboBox1.getSelectedItem().toString();
            int ma=Integer.parseInt(jTextField1.getText());
            GiangVien b=new GiangVien(ma, ten, dc, trdo);
            tm.setValueAt(ma, row, 0);
            tm.setValueAt(ten, row, 1);
            tm.setValueAt(dc, row, 2);
            tm.setValueAt(trdo, row, 3);
            l.set(row, b);
            sua=false;
            buttonSate(true);
        }
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if(row>=0 && row<jTable1.getRowCount()){
            ...
            String trdo=tm.getValueAt(row,3).toString();    
            for(int i=0;i<jComboBox1.getItemCount();i++){
                if(jComboBox1.getItemAt(i).toString().equals(trdo)){
