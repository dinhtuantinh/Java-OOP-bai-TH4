 ...
 * @author Admin
 */
public class FormMon extends javax.swing.JPanel {

    DefaultTableModel tm;
    private boolean them,sua;
    private String f;
    private List<MonHoc> l;
    public FormMon() {
        initComponents();
        setSize(950,850);
        String[] cols={"Ma mon","Ten mon","Tong so tiet","So tiet ly thuyet",
            "muc kinh phi"};
    ...
    private void initComponents() {
        ...
        jLabel3.setText("So tiet ly thuyet");
    ...
    private void btCapNhatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCapNhatActionPerformed
        ...
        if(them){
            String ten, st,ly,mkp;
            try{
               ten=jTextField2.getText();
               st=jTextField3.getText();
               ly=jTextField4.getText();
               mkp=jTextField5.getText();
               if(ten.isEmpty()|| st.isEmpty()||ly.isEmpty()||mkp.isEmpty()) throw new TrongException();
               int tiet=Integer.parseInt(jTextField3.getText());
               int lt=Integer.parseInt(jTextField4.getText());
               int phi=Integer.parseInt(jTextField5.getText());
               int ma=Integer.parseInt(jTextField1.getText());
               MonHoc s=new MonHoc(ma,ten,tiet,lt,phi);
        ...
        if(sua){
            ...
            int ma=Integer.parseInt(jTextField1.getText());
            int tiet=Integer.parseInt(tm.getValueAt(row, 2).toString());
            int lt=Integer.parseInt(tm.getValueAt(row, 3).toString());
            int phi=Integer.parseInt(tm.getValueAt(row, 4).toString());
            try{
                tiet=Integer.parseInt(jTextField3.getText());
                lt=Integer.parseInt(jTextField4.getText());
                phi=Integer.parseInt(jTextField5.getText());
            }catch(NumberFormatException e){
                JOptionPane.showMessageDialog(this, "Nhap so");
            }
            MonHoc s=new MonHoc(ma,ten,tiet,lt,phi);
            ...
            tm.setValueAt(tiet, row, 2);
            tm.setValueAt(lt, row, 3);
            tm.setValueAt(phi, row, 4);
            l.set(row, s);
            sua=false;
            buttonSate(true);
        }
    ...
    private void btXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btXoaActionPerformed
        ...
        int row=jTable1.getSelectedRow();
        if(row<0 || row>jTable1.getRowCount()-1)
            JOptionPane.showMessageDialog(this, "Chon mon de xoa");
        else{
            tm.removeRow(row);
            l.remove(row);
        }
