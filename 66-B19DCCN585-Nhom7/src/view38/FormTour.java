...
import controller38.SoLuongException;
...
public class FormTour extends javax.swing.JPanel {
    ...
    public FormTour() {
        initComponents();
        setSize(950,850);
        String[] cols={"Ma Tour","Kieu Tour","Thong tin tour","Don gia"};
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Kieu tour");

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Một ngày", "Dưới Năm ngày", "Dưới Bảy ngày", "Dài ngày" }));
    ...
    private void btCapNhatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCapNhatActionPerformed
        ...
        if(them){
            String thongtin, dongia;
            try{
               thongtin=jTextField2.getText();
               dongia=jTextField3.getText();
               if(thongtin.isEmpty()||dongia.isEmpty()) throw new TrongException();
               int ma=Integer.parseInt(jTextField1.getText());
               long gia=Integer.parseInt(jTextField3.getText());
               Tour s=new Tour(ma,jComboBox1.getSelectedItem().toString(),thongtin,gia);
        ...
        if(sua){
            ...
            long gia=Integer.parseInt(jTextField3.getText());
            Tour s=new Tour(ma, kieu, thongtin,gia);
            tm.setValueAt(ma, row, 0);
            tm.setValueAt(kieu, row, 1);
            tm.setValueAt(thongtin, row, 2);
            tm.setValueAt(gia, row, 3);
            ltour.set(row, s);
            sua=false;
            buttonSate(true);
        }
    ...
    private void btThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btThemActionPerformed
        ...
        buttonSate(false);
        them=true;
        if(ltour!=null && ltour.size()>0)
            Tour.setSma(ltour.get(ltour.size()-1).getMa()+1);
        else
            ltour=new ArrayList<>();
    ...
    private void btSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSuaActionPerformed
        ...
        if(row<0 || row>jTable1.getRowCount()-1)
            JOptionPane.showMessageDialog(this, "Chon tour de sua");
        else{
            sua=true;
            buttonSate(false);
            jTextField2.requestFocus();
