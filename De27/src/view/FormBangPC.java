...
public class FormBangPC extends javax.swing.JPanel {
    ...
    private String f2;
    private List<BaiTap> l2;
    public FormBangPC() {
        initComponents();
        setSize(950,850);
        String[] cols={"Ma SV","Ten SV","Ma BT","ten BT","So ngay"};
        tm=new DefaultTableModel(cols, 0);
        jTable1.setModel(tm);
        f1="src/controller/PHANCONG.dat";
        f2="src/controller/BT.dat";
        loadData();
        load2Ma();
    }
...
//    }
    ...
    private void initComponents() {
        ...
        cbSapXep.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "...Lua chon sap xep...", "Ten sinh vien", "So ngay giam" }));
    ...
    private BaiTap getBTByMa(int ma){
            for(BaiTap i:l2)
                if(i.getMa()==ma)
                    return i;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int sl=0;
        int slh=getBTByMa(ma2).getTime();
        try{
            sl=Integer.parseInt(jTextField1.getText());
            if(sl>slh){
                JOptionPane.showMessageDialog(this, "Qua han");
                jTextField1.requestFocus();
                return;
            }
            BangPC ql=new BangPC(getSVByMa(ma1),getBTByMa(ma2), sl);
