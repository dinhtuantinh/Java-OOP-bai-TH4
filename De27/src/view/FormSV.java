...
public class FormSV extends javax.swing.JPanel {
    ...
    public FormSV() {
        initComponents();
        setSize(950,850);
        String[] cols={"Ma SV","Ten SV","dia chi","lol"};
    ...
    private void btCapNhatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCapNhatActionPerformed
        ...
        if(them){
            ...
            try{
               ...
               lop=jTextField4.getText();
               if(ten.isEmpty()||dchi.isEmpty()||lop.isEmpty()) throw new TrongException();
               int ma=Integer.parseInt(jTextField1.getText());
               SinhVien b=new SinhVien(ma,ten,dchi,lop);
