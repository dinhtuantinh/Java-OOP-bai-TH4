...
public class FormKH extends javax.swing.JPanel {
    ...
    public FormKH() {
        initComponents();
        setSize(950,850);
        String[] cols={"Ma KH","Hoc va ten","Loai phong can thue","So phong"};
...
//    }
    ...
    private void btCapNhatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCapNhatActionPerformed
        ...
        if(them){
            String hoten, loai, sl;
            try{
               hoten=jTextField2.getText();
               loai=jTextField3.getText();
               sl=jTextField4.getText();
               if(hoten.isEmpty()|| loai.isEmpty()||sl.isEmpty()) throw new TrongException();
               ...
               KhachHang b=new KhachHang(ma,hoten,loai,sluong);
        ...
        if(sua){
            ...
            KhachHang b=new KhachHang(ma, hoten, dc, sl);
