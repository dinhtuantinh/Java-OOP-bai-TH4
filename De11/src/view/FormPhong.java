...
public class FormPhong extends javax.swing.JPanel {
    ...
    public FormPhong() {
        initComponents();
        setSize(950,850);
        String[] cols={"Ma phong","Kieu phong","Muc thue","So luong"};
    ...
    private void btCapNhatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCapNhatActionPerformed
        ...
        if(them){
            String mucthue, sophong;
            try{
               mucthue=jTextField2.getText();
               sophong=jTextField3.getText();
               if(mucthue.isEmpty()|| sophong.isEmpty()) throw new TrongException();
               ...
               Phong s=new Phong(ma,jComboBox1.getSelectedItem().toString(),muc,sp);
        ...
        if(sua){
            ...
            int muc=Integer.parseInt(tm.getValueAt(row, 2).toString());
            int sl=Integer.parseInt(tm.getValueAt(row, 3).toString());
            try{
                muc=Integer.parseInt(jTextField2.getText());
            }catch(NumberFormatException e){
                JOptionPane.showMessageDialog(this, "Nhap so");
            }
            Phong s=new Phong(ma,kieu, muc, sl);
            tm.setValueAt(ma, row, 0);
            tm.setValueAt(kieu, row, 1);
            tm.setValueAt(muc, row, 2);
