 ...
 * @author Admin
 */
public class FormSoTK extends javax.swing.JPanel {

    DefaultTableModel tm;
    private String f1;
    private List<SoTK> l1;
    private String f2;
    private List<NganHang> l2;
    public FormSoTK() {
        initComponents();
        setSize(950,850);
        String[] cols={"Ma KH","Ho ten","Ma NH","Ten NH",
            "so tien gui"};
        tm=new DefaultTableModel(cols, 0);
        jTable1.setModel(tm);
        f1="src/controller/SOTK.dat";
        f2="src/controller/NGANHANG.dat";
        loadData();
        load2Ma();
    }
...
//    }
    ...
    private void initComponents() {
        ...
        cbSapXep.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "...Lua chon sap xep...", "Ho ten KH", "So tien gui" }));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            int sotk=Integer.parseInt(jTextField1.getText());
            
            SoTK ql=new SoTK(getKHByMa(ma1),getNHByMa(ma2), sotk);
    ...
    private void cbSapXepItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cbSapXepItemStateChanged
        ...
        if(cbSapXep.getSelectedIndex()==1){
            l1.sort(new Comparator<SoTK>(){
                @Override
                public int compare(SoTK o1, SoTK o2) {
