...
public class FormNganHang extends javax.swing.JPanel {
    ...
    private String f;
    private List<NganHang> l;
    //private List<Phong> l2;
    public FormNganHang() {
        initComponents();
        setSize(950,850);
        String[] cols={"Ma NH","ten","Lai suat"};
        tm=new DefaultTableModel(cols, 0);
        jTable1.setModel(tm);
        buttonSate(true);
        them=false;
        sua=false;
        f="src/controller/NGANHANG.dat";
        loadData();
    }
...
//    }
    ...
    private void btCapNhatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCapNhatActionPerformed
        ...
        if(them){
            ...
            try{
               ...
               laisuat=jTextField3.getText();
               
               if(ten.isEmpty()|| laisuat.isEmpty()) throw new TrongException();
               int ma=Integer.parseInt(jTextField1.getText());
               double ls=Double.parseDouble(jTextField3.getText());
               //if(loai.equalsIgnoreCase(getPhongByMa()))
               NganHang b=new NganHang(ma,ten,ls);
        ...
        if(sua){
            ...
            int ma=Integer.parseInt(jTextField1.getText());
            ls=Double.parseDouble(jTextField3.getText());
            NganHang b=new NganHang(ma, ten, ls);
            tm.setValueAt(ma, row, 0);
            tm.setValueAt(ten, row, 1);
            tm.setValueAt(ls, row, 2);
    ...
    private void btThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btThemActionPerformed
        ...
        if(l!=null && l.size()>0)
            ...
            l=new ArrayList<>();
        jTextField1.setText(NganHang.getSma()+"");
        jTextField2.requestFocus();
    ...
    private void btSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSuaActionPerformed
        ...
        if(row<0 || row>jTable1.getRowCount()-1)
            JOptionPane.showMessageDialog(this, "Chon ngan hang de sua");
        else{
            sua=true;
            buttonSate(false);
            jTextField2.requestFocus();
