...
public class FormSach extends javax.swing.JPanel {
    ...
    public FormSach() {
        initComponents();
        setSize(950,850);
        String[] cols={"Ma Sach","Ten","Tac gia","Chuyen nganh","Nham XB"};
        tm=new DefaultTableModel(cols, 0);
        jTable1.setModel(tm);
        buttonSate(true);
        them=false;
        sua=false;
        f="src/controller/SACH.dat";
        loadData();
    ...
    private void btCapNhatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCapNhatActionPerformed
        ...
        if(them){
            ...
            try{
               ...
               namxb=jTextField4.getText();
               if(ten.isEmpty()|| tg.isEmpty()|| namxb.isEmpty()) throw new TrongException();
               int nam=Integer.parseInt(jTextField4.getText());
               
               int ma=Integer.parseInt(jTextField1.getText());
               Sach s=new Sach(ma,ten,tg,jComboBox1.getSelectedItem().toString(),nam);
        ...
        if(sua){
            ...
            String tg=jTextField3.getText();
            int ma=Integer.parseInt(jTextField1.getText());
            String cn=jComboBox1.getSelectedItem().toString();
            
            int nam=Integer.parseInt(tm.getValueAt(row, 4).toString());
            try{
                nam=Integer.parseInt(jTextField4.getText());
            }catch(NumberFormatException e){
                JOptionPane.showMessageDialog(this, "Nhap so");
            }
            Sach s=new Sach(ma,ten,tg,cn,nam);
            tm.setValueAt(ma, row, 0);
            tm.setValueAt(ten, row, 1);
            tm.setValueAt(tg, row, 2);
            tm.setValueAt(cn, row, 3);
            tm.setValueAt(nam, row, 4);
            l.set(row, s);
            sua=false;
            buttonSate(true);
        }
