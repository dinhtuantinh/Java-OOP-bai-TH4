...
public class FormHoaDon extends javax.swing.JPanel {
    ...
    private String f1;
    private List<BangHD> l1;
    private String f2;
    private List<MatHang> l2;
    public FormHoaDon() {
        initComponents();
        setSize(950,850);
        String[] cols={"Ma KH","Ho ten","Ma hang","Ten hang",
            "so luong"};
        tm=new DefaultTableModel(cols, 0);
        jTable1.setModel(tm);
        f1="src/controller/HOADON.dat";
        f2="src/controller/MATHANG.dat";
        loadData();
        load2Ma();
    }
    ...
    private boolean trung2Ma(int makh, int mah){
        for(BangHD i:l1)
            if(i.getKh().getMa()==makh && i.getMh().getMa()==mah)
                return true;
        return false;
    } 
...
//    }
    ...
    private void initComponents() {
        ...
        cbSapXep.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "...Lua chon sap xep...", "Ho ten khach hang", "So luong mua" }));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            int tien=getMHByMa(ma2).getGia()*sl;
            BangHD ql=new BangHD(getKHByMa(ma1),getMHByMa(ma2),sl, tien);
    ...
    private void cbSapXepItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cbSapXepItemStateChanged
        ...
        if(cbSapXep.getSelectedIndex()==1){
            l1.sort(new Comparator<BangHD>(){
                @Override
                public int compare(BangHD o1, BangHD o2) {
