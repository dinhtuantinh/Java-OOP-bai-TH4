 ...
 * @author Admin
 */
public class FormMHang extends javax.swing.JPanel {
    ...
    public FormMHang() {
        initComponents();
        setSize(950,850);
        String[] cols={"Ma hang","ten hang","don gia"};
        tm=new DefaultTableModel(cols, 0);
        jTable1.setModel(tm);
        buttonSate(true);
        them=false;
        sua=false;
        f="src/controller/MATHANG.dat";
        loadData();
    }
    ...
    private void btCapNhatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCapNhatActionPerformed
        ...
        if(them){
            ...
            try{
               ...
               if(ten.isEmpty()|| gia.isEmpty()) throw new TrongException();
               int ma=Integer.parseInt(jTextField1.getText());
               int dgia=Integer.parseInt(jTextField3.getText());
               //if(loai.equalsIgnoreCase(getPhongByMa()))
               MatHang b=new MatHang(ma,ten,dgia);
        ...
        if(sua){
            ...
            MatHang b=new MatHang(ma, ten, gia);
