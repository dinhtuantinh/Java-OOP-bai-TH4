...
public class FormPhong extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Phòng họp", "Phòng làm việc", "Phòng riêng" }));
    ...
    private void btCapNhatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCapNhatActionPerformed
        ...
        if(them){
            ...
            try{
               ...
               Phong b=new Phong(ma,ten,jComboBox1.getSelectedItem().toString());
        ...
        if(sua){
            ...
            ten=jTextField2.getText();
            int ma=Integer.parseInt(jTextField1.getText());
            String phong=jComboBox1.getSelectedItem().toString();
            Phong b=new Phong(ma, ten,phong);
            tm.setValueAt(ma, row, 0);
            tm.setValueAt(ten, row, 1);
            tm.setValueAt(phong, row, 2);
            l.set(row, b);
            sua=false;
            buttonSate(true);
        }
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if(row>=0 && row<jTable1.getRowCount()){
            ...
            String kieu=tm.getValueAt(row,2).toString();
