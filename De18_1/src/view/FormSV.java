...
public class FormSV extends javax.swing.JPanel {
    ...
    public FormSV() {
        initComponents();
        setSize(950,850);
        String[] cols={"Ma","Ten","dia chi","ngay sinh","lop"};
        tm=new DefaultTableModel(cols, 0);
        jTable1.setModel(tm);
        buttonSate(true);
        them=false;
        sua=false;
        f="src/controller/SV.dat";
        loadData();
    }
    ...
    private void btCapNhatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCapNhatActionPerformed
        ...
        if(them){
            ...
            try{
               ...
               ns=jTextField4.getText();
               lop=jTextField5.getText();
               if(ten.isEmpty()||g.isEmpty()||ns.isEmpty()||lop.isEmpty()) throw new TrongException();
               int ma=Integer.parseInt(jTextField1.getText());
               SinhVien b=new SinhVien(ma,ten,g,ns,lop);
        ...
        if(sua){
            ...
            tm.setValueAt(ns, row, 3);
            tm.setValueAt(lop, row, 4);
            l.set(row, b);
            sua=false;
            buttonSate(true);
        }
    ...
    private void btSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSuaActionPerformed
        ...
        if(row<0 || row>jTable1.getRowCount()-1)
            JOptionPane.showMessageDialog(this, "Chon SV de sua");
        else{
            sua=true;
            buttonSate(false);
            jTextField2.requestFocus();
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if(row>=0 && row<jTable1.getRowCount()){
            ...
            jTextField5.setText(tm.getValueAt(row,4).toString());           
        }
