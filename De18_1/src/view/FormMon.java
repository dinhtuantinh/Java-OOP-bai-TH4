...
public class FormMon extends javax.swing.JPanel {
    ...
    public FormMon() {
        initComponents();
        setSize(950,850);
        String[] cols={"Ma","Ten","So dvht","loai mon"};
        tm=new DefaultTableModel(cols, 0);
        jTable1.setModel(tm);
        buttonSate(true);
        them=false;
        sua=false;
        f="src/controller/MONHOC.dat";
        loadData();
    ...
    private void btCapNhatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCapNhatActionPerformed
        ...
        if(them){
            ...
            try{
               ...
               MonHoc s=new MonHoc(ma,ten,tg,jComboBox1.getSelectedItem().toString());
...
//                JOptionPane.showMessageDialog(this, "Nhap so");
//            }
            MonHoc s=new MonHoc(ma,ten,g,loai);
