 ...
 * @author Admin
 */
public class FormLoaiCV extends javax.swing.JPanel {

    DefaultTableModel tm;
    private boolean them,sua;
    private String f;
    private List<LoaiCV> l;
    public FormLoaiCV() {
        initComponents();
        setSize(950,850);
        String[] cols={"Ma CV","Ten CV","Kieu CV","Phi"};
        tm=new DefaultTableModel(cols, 0);
        jTable1.setModel(tm);
        buttonSate(true);
        them=false;
        sua=false;
        f="src/controller/CV.dat";
        loadData();
    ...
    private void btCapNhatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCapNhatActionPerformed
        ...
        if(them){
            ...
            try{
               ...
               muc=jTextField3.getText();
               
               if(ten.isEmpty()|| muc.isEmpty()) throw new TrongException();
               int m=Integer.parseInt(jTextField3.getText());
               
               int ma=Integer.parseInt(jTextField1.getText());
               LoaiCV s=new LoaiCV(ma,ten,jComboBox1.getSelectedItem().toString(),m);
        ...
        if(sua){
            ...
            int m=Integer.parseInt(tm.getValueAt(row, 3).toString());
            try{
                m=Integer.parseInt(jTextField3.getText());
            }catch(NumberFormatException e){
                JOptionPane.showMessageDialog(this, "Nhap so");
            }
            LoaiCV s=new LoaiCV(ma,ten,kieu,m);
            tm.setValueAt(ma, row, 0);
            tm.setValueAt(ten, row, 1);
            tm.setValueAt(kieu, row, 2);
            tm.setValueAt(m, row, 3);
    ...
    private void btThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btThemActionPerformed
        ...
        them=true;
        if(l!=null && l.size()>0)
            LoaiCV.setSma(l.get(l.size()-1).getMa()+1);
        else
            l=new ArrayList<>();
        jTextField1.setText(LoaiCV.getSma()+"");
        jTextField2.requestFocus();
    ...
    private void btSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSuaActionPerformed
        ...
        if(row<0 || row>jTable1.getRowCount()-1)
            JOptionPane.showMessageDialog(this, "Chon CV de sua");
        else{
            sua=true;
            buttonSate(false);
            jTextField2.requestFocus();
    ...
    private void btXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btXoaActionPerformed
        ...
        int row=jTable1.getSelectedRow();
        if(row<0 || row>jTable1.getRowCount()-1)
            JOptionPane.showMessageDialog(this, "Chon CV de xoa");
        else{
            tm.removeRow(row);
            l.remove(row);
        }
