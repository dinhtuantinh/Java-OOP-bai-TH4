 ...
 * @author Admin
 */
public class FormBangTC extends javax.swing.JPanel {

    DefaultTableModel tm;
    private String f1;
    private List<BangQL> l1;
    private String f2;
    private List<LoaiCV> l2;
    public FormBangTC() {
        initComponents();
        setSize(950,850);
        ...
        jTable1.setModel(tm);
        f1="src/controller/QLCTV.dat";
        f2="src/controller/CV.dat";
        loadData();
        load2Ma();
    }
    ...
    private void load2Ma(){
        ...
        String fbd="src/controller/CTV.dat";
        List<CTV> l1=IOFile.doc(fbd);
        if(l1!=null){
            for(CTV i:l1)
...
//    }
    ...
    private void initComponents() {
        ...
        cbSapXep.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "...Lua chon sap xep...", "Ten CTV", "So gio lam giam" }));
    ...
    private LoaiCV getCVByMa(int ma){
            for(LoaiCV i:l2)
                if(i.getMa()==ma)
                    return i;
    ...
    private CTV getCTVByMa(int ma){
        String f3="src/controller/CTV.dat";
        List<CTV> l1=IOFile.doc(f3);
        if(l1!=null){
            for(CTV i:l1)
                if(i.getMa()==ma)
                    return i;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            if(sl>240){
                JOptionPane.showMessageDialog(this, "Vuot qua so gio");
                jTextField1.requestFocus();
                return;
            }
            int tien=getCVByMa(ma2).getMucphi()*sl;
            BangQL ql=new BangQL(getCTVByMa(ma1),getCVByMa(ma2), sl, tien);
