...
public class FormBangDSCC extends javax.swing.JPanel {
    ...
    private String f2;
    private List<PhongBan> l2;
    public FormBangDSCC() {
        initComponents();
        setSize(950,850);
        String[] cols={"Ma NV","Ten NV","Ma Phong","ten phong",
            "so ngay"};
        tm=new DefaultTableModel(cols, 0);
        jTable1.setModel(tm);
        f1="src/controller/QLNS.dat";
        f2="src/controller/PB.dat";
        loadData();
        load2Ma();
    }
    ...
    private void initComponents() {
        ...
        cbSapXep.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "...Lua chon sap xep...", "Ten nhan vien", "phong ban" }));
    ...
    private PhongBan getXuongByMa(int ma){
            for(PhongBan i:l2)
                if(i.getMa()==ma)
                    return i;
    ...
    private NhanVien getCNByMa(int ma){
...
//            }
            ...
            int luong=(int)(850*((2+(double)getCNByMa(ma1).getBac())/3)*(getXuongByMa(ma2).getHeso())*(double)(sngay/22));
