...
public class FormNV extends javax.swing.JPanel {
    ...
    private String f;
    private List<NhanVien> l;
    //private List<Phong> l2;
    public FormNV() {
        initComponents();
        setSize(950,850);
        String[] cols={"Ma NV","Ten CN","Dia chi","So dien thoai","Bac luong"};
        tm=new DefaultTableModel(cols, 0);
        jTable1.setModel(tm);
        buttonSate(true);
        them=false;
        sua=false;
        f="src/controller/NV.dat";
        loadData();
    }
    ...
    private void btCapNhatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCapNhatActionPerformed
        ...
        if(them){
            ...
            try{
               ...
               if(ten.isEmpty()||sdt.isEmpty()||sdt.isEmpty()) throw new TrongException();
               int ma=Integer.parseInt(jTextField1.getText());
               int dt=Integer.parseInt(jTextField4.getText());
               int bac=Integer.parseInt(jComboBox1.getSelectedItem().toString());
               //if(loai.equalsIgnoreCase(getPhongByMa()))
               NhanVien b=new NhanVien(ma,ten,dc,dt,bac);
    ...
    private void btSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSuaActionPerformed
        ...
        if(row<0 || row>jTable1.getRowCount()-1)
            JOptionPane.showMessageDialog(this, "Chon nv de sua");
        else{
            sua=true;
            buttonSate(false);
            jTextField2.requestFocus();
    ...
    private void btXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btXoaActionPerformed
        ...
        int row=jTable1.getSelectedRow();
        if(row<0 && row>jTable1.getRowCount()-1)
            JOptionPane.showMessageDialog(this, "Chon nv de xoa");
        else{
            tm.removeRow(row);
            l.remove(row);
        }
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if(row>=0 && row<jTable1.getRowCount()){
            ...
            String bac=tm.getValueAt(row,4).toString();
