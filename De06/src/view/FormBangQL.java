...
public class FormBangQL extends javax.swing.JPanel {
    ...
    private String f2;
    private List<ThietBi> l2;
    public FormBangQL() {
        initComponents();
        setSize(950,850);
        String[] cols={"Ma phong","Ten phong","Ma TB","ten TB","So luong"};
        tm=new DefaultTableModel(cols, 0);
        jTable1.setModel(tm);
        f1="src/controller/QLTB.dat";
        f2="src/controller/TB.dat";
        loadData();
        load2Ma();
    }
    ...
    private void load2Ma(){
        ...
        String fbd="src/controller/PH.dat";
        List<PhongHoc> l1=IOFile.doc(fbd);
        if(l1!=null){
            for(PhongHoc i:l1)
...
//    }
    ...
    private void initComponents() {
        ...
        cbSapXep.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "...Lua chon sap xep...", "Ten phong", "So luong TB giam" }));
    ...
    private ThietBi getBTByMa(int ma){
            for(ThietBi i:l2)
                if(i.getMa()==ma)
                    return i;
    ...
    private PhongHoc getSVByMa(int ma){
        String f3="src/controller/PH.dat";
        List<PhongHoc> l1=IOFile.doc(f3);
        if(l1!=null){
            for(PhongHoc i:l1)
                if(i.getMa()==ma)
                    return i;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            BangQL ql=new BangQL(getSVByMa(ma1),getBTByMa(ma2), sl);
