...
public class FormKH extends javax.swing.JPanel {
    ...
    public FormKH() {
        initComponents();
        setSize(950,850);
        String[] cols={"Ma kh","Ten kh","dia chi","sdt"};
    ...
    private void btCapNhatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCapNhatActionPerformed
        ...
        if(them){
            String ten,dchi,dthoai;
            try{
               ten=jTextField2.getText();
               dchi=jTextField3.getText();
               dthoai=jTextField4.getText();
               if(ten.isEmpty()||dchi.isEmpty()||dthoai.isEmpty()) throw new TrongException();
               int ma=Integer.parseInt(jTextField1.getText());
               int sdt=Integer.parseInt(jTextField4.getText());
               //if(loai.equalsIgnoreCase(getPhongByMa()))
               KhachHang b=new KhachHang(ma,ten,dchi,sdt);
        ...
        if(sua){
            ...
            KhachHang b=new KhachHang(ma, ten, dc, sdt);
