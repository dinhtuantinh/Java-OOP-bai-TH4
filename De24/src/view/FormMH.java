...
public class FormMH extends javax.swing.JPanel {
    ...
    private String f;
    private List<MatHang> l;
    public FormMH() {
        initComponents();
        setSize(950,850);
        String[] cols={"Ma hang","Ten","Nhom hang","Gia ban","so luong"};
        tm=new DefaultTableModel(cols, 0);
        jTable1.setModel(tm);
        buttonSate(true);
        them=false;
        sua=false;
        f="src/controller/MH.dat";
        loadData();
    ...
    private void btCapNhatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCapNhatActionPerformed
        ...
        if(them){
            String ten, giaban, sluong;
            try{
               ten=jTextField2.getText();
               giaban=jTextField3.getText();
               sluong=jTextField4.getText();
               if(ten.isEmpty()|| giaban.isEmpty()|| sluong.isEmpty()) throw new TrongException();
               ...
               MatHang s=new MatHang(ma,ten,jComboBox1.getSelectedItem().toString(),gia,sl);
        ...
        if(sua){
            ...
            int gia=Integer.parseInt(tm.getValueAt(row, 3).toString());
            ...
            MatHang s=new MatHang(ma,ten,loai,gia,sl);
    ...
    private void btThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btThemActionPerformed
        ...
        them=true;
        if(l!=null && l.size()>0)
            MatHang.setSma(l.get(l.size()-1).getMa()+1);
        else
            l=new ArrayList<>();
