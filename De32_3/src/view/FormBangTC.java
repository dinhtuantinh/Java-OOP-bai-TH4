...
public class FormBangTC extends javax.swing.JPanel {
    ...
    private String f1;
    private List<BangTC> l1;
    private String f2;
    private List<KieuBV> l2;
    public FormBangTC() {
        initComponents();
        setSize(950,850);
        String[] cols={"Ma PV","Ten PV","Ma bai","kieu bai","so luong"};
        tm=new DefaultTableModel(cols, 0);
        jTable1.setModel(tm);
        f1="src/controller/TINHCONG.dat";
        f2="src/controller/KB.dat";
        loadData();
        load2Ma();
    }
    ...
    private void load2Ma(){
        ...
        String fbd="src/controller/PV.dat";
        List<PhongVien> l1=IOFile.doc(fbd);
        if(l1!=null){
            for(PhongVien i:l1)
...
//    }
    ...
    private void initComponents() {
        ...
        cbSapXep.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "...Lua chon sap xep...", "Ten phong vien", "So bai giam" }));
    ...
    private KieuBV getKBByMa(int ma){
            for(KieuBV i:l2)
                if(i.getMa()==ma)
                    return i;
    ...
    private PhongVien getPVByMa(int ma){
        String f3="src/controller/PV.dat";
        List<PhongVien> l1=IOFile.doc(f3);
        if(l1!=null){
            for(PhongVien i:l1)
                if(i.getMa()==ma)
                    return i;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            int tien=sl*getKBByMa(ma2).getDgia();
            BangTC ql=new BangTC(getPVByMa(ma1),getKBByMa(ma2), sl,tien);
    ...
    private void cbSapXepItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cbSapXepItemStateChanged
        ...
        if(cbSapXep.getSelectedIndex()==1){
            l1.sort(new Comparator<BangTC>(){
                @Override
                public int compare(BangTC o1, BangTC o2) {
