...
public class FormBangPC extends javax.swing.JPanel {
    ...
    private String f2;
    private List<ViTriCV> l2;
    public FormBangPC() {
        initComponents();
        setSize(950,850);
        String[] cols={"Ma TV","Ten TV","Ma VT","ten VT","So ngay"};
        tm=new DefaultTableModel(cols, 0);
        jTable1.setModel(tm);
        f1="src/controller/PC.dat";
    ...
    private void load2Ma(){
        ...
        String fbd="src/controller/TV.dat";
        List<ThanhVien> l1=IOFile.doc(fbd);
        if(l1!=null){
            for(ThanhVien i:l1)
...
//    }
    ...
    private void initComponents() {
        ...
        cbSapXep.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "...Lua chon sap xep...", "Ten thanh vien", "So ngay giam" }));
    ...
    private ViTriCV getVTByMa(int ma){
            for(ViTriCV i:l2)
                if(i.getMa()==ma)
                    return i;
    ...
    private ThanhVien getTVByMa(int ma){
        String f3="src/controller/TV.dat";
        List<ThanhVien> l1=IOFile.doc(f3);
        if(l1!=null){
            for(ThanhVien i:l1)
                if(i.getMa()==ma)
                    return i;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            int thuong=getVTByMa(ma2).getMuct()+10*getTVByMa(ma1).getMucl();
            BangPC ql=new BangPC(getTVByMa(ma1),getVTByMa(ma2), sn,thuong);
    ...
    private void cbSapXepItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cbSapXepItemStateChanged
        ...
        if(cbSapXep.getSelectedIndex()==2){
            l1.sort(new Comparator<BangPC>(){
                @Override
                public int compare(BangPC o1, BangPC o2) {
                   return Integer.compare(o2.getTg(), o1.getTg());
                }
