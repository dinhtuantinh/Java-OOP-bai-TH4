...
import controller28.DienThoaiException;
...
public class FormLop extends javax.swing.JPanel {
    ...
    public FormLop() {
        initComponents();
        setSize(950,850);
        String[] cols={"Ma lop","Ten Lop","So sinh vien"};
    ...
    private void btThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btThemActionPerformed
        ...
        if(llop!=null && llop.size()>0)
            Lop.setSma(llop.get(llop.size()-1).getMa()+1);
        else
            llop=new ArrayList<>();
    ...
    private void btXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btXoaActionPerformed
        ...
        int row=jTable1.getSelectedRow();
        if(row<0 && row>jTable1.getRowCount()-1)
            JOptionPane.showMessageDialog(this, "Chon lop de xoa");
        else{
            tm.removeRow(row);
            llop.remove(row);
        }
