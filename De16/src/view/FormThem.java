...
public class FormThem extends javax.swing.JPanel {
    ...
    private String f;
    private List<HoaDon> l;
    public FormThem() {
        initComponents();
        setSize(950,850);
        String[] cols={"Ma nguoi","Ten","Ma ve","Loai ve", "So luong","Tien"};
...
//        show(lqlMuon);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        for(HoaDon i:l)
            if((i.getN().getTen()).toLowerCase().contains(key) 
                    || (i.getV().getLoai().toLowerCase().contains(key)))
                lsearch.add(i);
        show(lsearch);
