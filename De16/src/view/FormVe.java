...
public class FormVe extends javax.swing.JPanel {
    ...
    private String f;
    private List<VeTau> l;
    public FormVe() {
        initComponents();
        setSize(950,850);
        String[] cols={"Ma ","Loai ghe","Gia"};
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        if(row<0||row>jTable1.getRowCount()-1)
            JOptionPane.showConfirmDialog(this, "Chon ve de xoa");
        else{
            tm.removeRow(row);
            l.remove(row);
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        them=true;
        if(l!=null&&l.size()>0)
            VeTau.setSma(l.get(l.size()-1).getMa()+1);
        else
            l=new ArrayList<>();
        jTextField1.setText(VeTau.getSma()+"");
        jTextField2.requestFocus();
