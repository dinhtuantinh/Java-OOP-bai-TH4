 ...
 * @author Admin
 */
public class FormXuongSX extends javax.swing.JPanel {

    DefaultTableModel tm;
    private boolean them,sua;
    private String f;
    private List<XuongSX> l;
    public FormXuongSX() {
        initComponents();
        setSize(950,850);
        String[] cols={"Ma xuong","Ten xuong","Mo ta","He so CV"};
        tm=new DefaultTableModel(cols, 0);
        jTable1.setModel(tm);
        buttonSate(true);
        them=false;
        sua=false;
        f="src/controller/XSX.dat";
        loadData();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Ma xuong");

        jLabel2.setText("Ten xuong");
    ...
    private void btCapNhatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCapNhatActionPerformed
        ...
        if(them){
            ...
            try{
               ...
               if(ten.isEmpty()|| mota.isEmpty()) throw new TrongException();
               int hs=Integer.parseInt(jComboBox1.getSelectedItem().toString());
               int ma=Integer.parseInt(jTextField1.getText());
               XuongSX s=new XuongSX(ma,ten,mota,hs);
        ...
        if(sua){
            ...
            int ma=Integer.parseInt(jTextField1.getText());
            int hs=Integer.parseInt(jComboBox1.getSelectedItem().toString());
            XuongSX s=new XuongSX(ma,ten,mt,hs);
            tm.setValueAt(ma, row, 0);
            tm.setValueAt(ten, row, 1);
            tm.setValueAt(mt, row, 2);
            tm.setValueAt(hs, row, 3);
    ...
    private void btThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btThemActionPerformed
        ...
        them=true;
        if(l!=null && l.size()>0)
            XuongSX.setSma(l.get(l.size()-1).getMa()+1);
        else
            l=new ArrayList<>();
        jTextField1.setText(XuongSX.getSma()+"");
        jTextField2.requestFocus();
    ...
    private void btXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btXoaActionPerformed
        ...
        int row=jTable1.getSelectedRow();
        if(row<0 || row>jTable1.getRowCount()-1)
            JOptionPane.showMessageDialog(this, "Chon xuong de xoa");
        else{
            tm.removeRow(row);
            l.remove(row);
        }
