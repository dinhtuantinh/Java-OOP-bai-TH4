...
public class FormTienPhong extends javax.swing.JPanel {

    DefaultTableModel tm;
    private String fktx;
    private List<KyTucXa> lktx;
    public FormTienPhong() {
        initComponents();
        setSize(950,850);
        String[] cols={"Ma phong","Ten phong","Ma SV","Ten SV", "ngay vao","Tien phong"};
    ...
    private void show(List<KyTucXa> list){
        tm.setRowCount(0);
        for(KyTucXa i:list)
    ...
    private void initComponents() {
        ...
        jRadioButton1.setText("Ho va ten SV");
        ...
        if(jRadioButton1.isSelected()){
            lktx.sort(new Comparator<KyTucXa>(){
                ...
                public int compare(KyTucXa o1, KyTucXa o2) {
                    String[] ht1=o1.getSinhvien().getHoten().split("\\s+");
                    String ten1=ht1[ht1.length-1];
                    String[] ht2=o2.getSinhvien().getHoten().split("\\s+");
    ...
    private void jRadioButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jRadioButton2ActionPerformed
        ...
        if(jRadioButton2.isSelected()){
            lktx.sort(new Comparator<KyTucXa>(){
                @Override
                public int compare(KyTucXa o1, KyTucXa o2) {
                    return o2.getPhong().getTen()-o1.getPhong().getTen();
                }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        List<KyTucXa> lsearch=new ArrayList<>();
        String key=jTextField1.getText().trim().toLowerCase();
        for(KyTucXa i:lktx)
            if((i.getPhong().getLphong()).toLowerCase().contains(key) 
                    || (i.getSinhvien().getHoten().toLowerCase().contains(key)))
                lsearch.add(i);
        show(lsearch);
