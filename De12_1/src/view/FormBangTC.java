...
//    }
    ...
    private void initComponents() {
        ...
        cbSapXep.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "...Lua chon sap xep...", "Ten cong nhan", "So luong SP giam" }));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            int tien=sl*getSPByMa(ma2).getDongia();
            BangTC ql=new BangTC(getCNByMa(ma1),getSPByMa(ma2), sl,tien);
