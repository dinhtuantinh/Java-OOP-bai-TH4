...
public class FormBangQL extends javax.swing.JPanel {
    ...
    private String f2;
    private List<MayTinh> l2;
    public FormBangQL() {
        initComponents();
        setSize(950,850);
        String[] cols={"Ma phong","Ten phong","So may","Ma may","Ten","So luong"};
        tm=new DefaultTableModel(cols, 0);
        jTable1.setModel(tm);
        f1="src/controller/QLTB.dat";
        f2="src/controller/MT.dat";
        loadData();
        load2Ma();
    }
    ...
    private void load2Ma(){
        ...
        String fbd="src/controller/PM.dat";
        List<PhongTH> l1=IOFile.doc(fbd);
        if(l1!=null){
            for(PhongTH i:l1)
...
//    }
    ...
    private void initComponents() {
        ...
        cbSapXep.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "...Lua chon sap xep...", "Ten phong", "So luong may giam" }));
    ...
    private PhongTH getPByMa(int ma){
        String f3="src/controller/PM.dat";
        List<PhongTH> l1=IOFile.doc(f3);
        if(l1!=null){
            for(PhongTH i:l1)
                if(i.getMa()==ma)
                    return i;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int sm=getPByMa(ma1).getSl();
        try{
            int sl=Integer.parseInt(jTextField1.getText());
            if(sl>sm||sl<sm){
                JOptionPane.showMessageDialog(this, "So luong phai bang so may");
                jTextField1.requestFocus();
                return;
            }
            BangQL ql=new BangQL(getPByMa(ma1),getMTByMa(ma2), sl);
