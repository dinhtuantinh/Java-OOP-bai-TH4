...
public class FormPhongTH extends javax.swing.JPanel {
    ...
    private String f;
    private List<PhongTH> l;
    //private List<Phong> l2;
    public FormPhongTH() {
        initComponents();
        setSize(950,850);
        String[] cols={"Ma phong","Ten","So may"};
        tm=new DefaultTableModel(cols, 0);
        jTable1.setModel(tm);
        buttonSate(true);
        them=false;
        sua=false;
        f="src/controller/PM.dat";
        loadData();
    }
    ...
    private void btCapNhatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCapNhatActionPerformed
        ...
        if(them){
            ...
            try{
               ...
               sl=jTextField3.getText();
               if(ten.isEmpty()||sl.isEmpty()) throw new TrongException();
               int ma=Integer.parseInt(jTextField1.getText());
               int sluong=Integer.parseInt(jTextField3.getText());
               PhongTH b=new PhongTH(ma,ten,sluong);
        ...
        if(sua){
            ...
            int ma=Integer.parseInt(jTextField1.getText());
            PhongTH b=new PhongTH(ma, ten,sl);
            tm.setValueAt(ma, row, 0);
            tm.setValueAt(ten, row, 1);
            tm.setValueAt(sl, row, 2);
            l.set(row, b);
            sua=false;
            buttonSate(true);
        }
    ...
    private void btThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btThemActionPerformed
        ...
        them=true;
        if(l!=null && l.size()>0)
            PhongTH.setSma(l.get(l.size()-1).getMa()+1);
        else
            l=new ArrayList<>();
