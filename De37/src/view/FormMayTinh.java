 ...
 * @author Admin
 */
public class FormMayTinh extends javax.swing.JPanel {

    DefaultTableModel tm;
    private boolean them,sua;
    private String f;
    private List<MayTinh> l;
    public FormMayTinh() {
        initComponents();
        setSize(950,850);
        String[] cols={"Ma may tinh","Ten","Xuat xu","Nam nhap","Cau hinh"};
        tm=new DefaultTableModel(cols, 0);
        jTable1.setModel(tm);
        buttonSate(true);
        them=false;
        sua=false;
        f="src/controller/MT.dat";
        loadData();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Ma may");

        jLabel2.setText("Ten");

        jLabel3.setText("Nam nhap");
    ...
    private void btCapNhatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCapNhatActionPerformed
        ...
        if(them){
            ...
            try{
               ...
               nam=jTextField3.getText();
               ch=jTextField4.getText();
               if(ten.isEmpty()|| nam.isEmpty()||ch.isEmpty()) throw new TrongException();
               int ma=Integer.parseInt(jTextField1.getText());
               int n=Integer.parseInt(jTextField3.getText());
               MayTinh s=new MayTinh(ma,ten,jComboBox1.getSelectedItem().toString(),n,ch);
        ...
        if(sua){
            ...
            String ch=jTextField4.getText();
            int ma=Integer.parseInt(jTextField1.getText());
            String xx=jComboBox1.getSelectedItem().toString();
            int n=Integer.parseInt(tm.getValueAt(row, 3).toString());
            try{
                n=Integer.parseInt(jTextField3.getText());
            }catch(NumberFormatException e){
                JOptionPane.showMessageDialog(this, "Nhap so");
            }
            MayTinh s=new MayTinh(ma,ten,xx,n,ch);
            tm.setValueAt(ma, row, 0);
            tm.setValueAt(ten, row, 1);
            tm.setValueAt(xx, row, 2);
            tm.setValueAt(n, row, 3);
            tm.setValueAt(ch, row, 3);
            l.set(row, s);
            sua=false;
            buttonSate(true);
        }
    ...
    private void btThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btThemActionPerformed
        ...
        them=true;
        if(l!=null && l.size()>0)
            MayTinh.setSma(l.get(l.size()-1).getMa()+1);
        else
            l=new ArrayList<>();
    ...
    private void btSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSuaActionPerformed
        ...
        if(row<0 || row>jTable1.getRowCount()-1)
            JOptionPane.showMessageDialog(this, "Chon may de sua");
        else{
            sua=true;
            buttonSate(false);
            jTextField2.requestFocus();
    ...
    private void btXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btXoaActionPerformed
        ...
        int row=jTable1.getSelectedRow();
        if(row<0 || row>jTable1.getRowCount()-1)
            JOptionPane.showMessageDialog(this, "Chon may de xoa");
        else{
            tm.removeRow(row);
            l.remove(row);
        }
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if(row<0 || row>jTable1.getRowCount()-1)
            ...
            String xx=tm.getValueAt(row,2).toString();
            ...
            for(int i=0;i<jComboBox1.getItemCount();i++){
                if(jComboBox1.getItemAt(i).toString().equals(xx)){
