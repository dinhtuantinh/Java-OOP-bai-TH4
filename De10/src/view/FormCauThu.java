...
public class FormCauThu extends javax.swing.JPanel {
    ...
    private String f;
    private List<CauThu> l;
    //private List<Phong> l2;
    public FormCauThu() {
        initComponents();
        setSize(950,850);
        String[] cols={"Ma CT","Ten CT","Tuoi","Muc luong"};
        tm=new DefaultTableModel(cols, 0);
        jTable1.setModel(tm);
        buttonSate(true);
        them=false;
        sua=false;
        f="src/controller/CT.dat";
        loadData();
    }
    ...
    private void btCapNhatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCapNhatActionPerformed
        ...
        if(them){
            ...
            try{
               ...
               muc=jTextField4.getText();
               if(ten.isEmpty()||tuoi.isEmpty()||muc.isEmpty()) throw new TrongException();
               ...
               CauThu b=new CauThu(ma,ten,t,ml);
        ...
        if(sua){
            ...
            ten=jTextField2.getText();
            int ma=Integer.parseInt(jTextField1.getText());
            int t=Integer.parseInt(tm.getValueAt(row, 2).toString());
    ...
    private void btSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSuaActionPerformed
        ...
        if(row<0 || row>jTable1.getRowCount()-1)
            JOptionPane.showMessageDialog(this, "Chon ct de sua");
        else{
            sua=true;
            buttonSate(false);
            jTextField2.requestFocus();
    ...
    private void btXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btXoaActionPerformed
        ...
        int row=jTable1.getSelectedRow();
        if(row<0 && row>jTable1.getRowCount()-1)
            JOptionPane.showMessageDialog(this, "Chon ct de xoa");
        else{
            tm.removeRow(row);
            l.remove(row);
        }
