...
public class FormDuAn extends javax.swing.JPanel {
    ...
    public FormDuAn() {
        initComponents();
        setSize(950,850);
        String[] cols={"Ma","Ten","Kieu du an","Tong kinh phi"};
        tm=new DefaultTableModel(cols, 0);
        jTable1.setModel(tm);
        buttonSate(true);
        them=false;
        sua=false;
        f="src/controller/DA.dat";
        loadData();
    ...
    private void btCapNhatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCapNhatActionPerformed
        ...
        if(them){
            ...
            try{
               ...
               DuAn s=new DuAn(ma,ten,jComboBox1.getSelectedItem().toString(),time);
        ...
        if(sua){
            ...
            DuAn s=new DuAn(ma,ten,loai,tg);
    ...
    private void btSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSuaActionPerformed
        ...
        if(row<0 || row>jTable1.getRowCount()-1)
            JOptionPane.showMessageDialog(this, "Chon DA de sua");
        else{
            sua=true;
            buttonSate(false);
            jTextField2.requestFocus();
    ...
    private void btXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btXoaActionPerformed
        ...
        int row=jTable1.getSelectedRow();
        if(row<0 || row>jTable1.getRowCount()-1)
            JOptionPane.showMessageDialog(this, "Chon DA de xoa");
        else{
            tm.removeRow(row);
            l.remove(row);
        }
