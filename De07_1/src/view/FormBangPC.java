...
public class FormBangPC extends javax.swing.JPanel {
    ...
    private String f2;
    private List<DuAn> l2;
    public FormBangPC() {
        initComponents();
        setSize(950,850);
        String[] cols={"Ma NV","Ten NV","Ma DA","ten DA","So ngay","Vi tri"};
        tm=new DefaultTableModel(cols, 0);
        jTable1.setModel(tm);
        f1="src/controller/PHANCONG.dat";
        f2="src/controller/DA.dat";
        loadData();
        load2Ma();
    }
    ...
    private void load2Ma(){
        ...
        String fbd="src/controller/NV.dat";
        List<NhanVien> l1=IOFile.doc(fbd);
        if(l1!=null){
            for(NhanVien i:l1)
...
//    }
    ...
    private void initComponents() {
        ...
        cbSapXep.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "...Lua chon sap xep...", "Ten nhan vien", "So ngay tham gia" }));
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(cbMa1, 0, 158, Short.MAX_VALUE)
    ...
    private NhanVien getNVByMa(int ma){
        String f3="src/controller/NV.dat";
        List<NhanVien> l1=IOFile.doc(f3);
        if(l1!=null){
            for(NhanVien i:l1)
                if(i.getMa()==ma)
                    return i;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            BangPC ql=new BangPC(getNVByMa(ma1),getDAByMa(ma2), sl,vt);
    ...
    private void cbSapXepItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cbSapXepItemStateChanged
        ...
        if(cbSapXep.getSelectedIndex()==2){
            l1.sort(new Comparator<BangPC>(){
                @Override
                public int compare(BangPC o1, BangPC o2) {
                   return Integer.compare(o2.getSn(), o1.getSn());
                }
