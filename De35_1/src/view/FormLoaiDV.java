 ...
 * @author Admin
 */
public class FormLoaiDV extends javax.swing.JPanel {

    DefaultTableModel tm;
    private boolean them,sua;
    private String f;
    private List<LoaiDV> l;
    public FormLoaiDV() {
        initComponents();
        setSize(950,850);
        String[] cols={"Ma","Mo ta","Don gia"};
        tm=new DefaultTableModel(cols, 0);
        jTable1.setModel(tm);
        buttonSate(true);
        them=false;
        sua=false;
        f="src/controller/DV.dat";
        loadData();
    ...
    private void btCapNhatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCapNhatActionPerformed
        ...
        if(sua){
            ...
            int ma=Integer.parseInt(jTextField1.getText());
            int tg=Integer.parseInt(tm.getValueAt(row, 2).toString());
            try{
                tg=Integer.parseInt(jTextField3.getText());
            }catch(NumberFormatException e){
                JOptionPane.showMessageDialog(this, "Nhap so");
            }
            LoaiDV s=new LoaiDV(ma,ten,tg);
    ...
    private void btThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btThemActionPerformed
        ...
        them=true;
        if(l!=null && l.size()>0)
            LoaiDV.setSma(l.get(l.size()-1).getMa()+1);
        else
            l=new ArrayList<>();
        jTextField1.setText(LoaiDV.getSma()+"");
        jTextField2.requestFocus();
    ...
    private void btSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSuaActionPerformed
        ...
        if(row<0 || row>jTable1.getRowCount()-1)
            JOptionPane.showMessageDialog(this, "Chon DV de sua");
        else{
            sua=true;
            buttonSate(false);
            jTextField2.requestFocus();
    ...
    private void btXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btXoaActionPerformed
        ...
        int row=jTable1.getSelectedRow();
        if(row<0 || row>jTable1.getRowCount()-1)
            JOptionPane.showMessageDialog(this, "Chon DV de xoa");
        else{
            tm.removeRow(row);
            l.remove(row);
        }
