...
public class FormHoaDon extends javax.swing.JPanel {
    ...
    private String f2;
    private List<LoaiDV> l2;
    public FormHoaDon() {
        initComponents();
        setSize(950,850);
        String[] cols={"Ma KH","Ten KH","Ma DV","kieu DV","so luong"};
        tm=new DefaultTableModel(cols, 0);
        jTable1.setModel(tm);
        f1="src/controller/HOADON.dat";
        f2="src/controller/DV.dat";
        loadData();
        load2Ma();
    }
...
//    }
    ...
    private LoaiDV getKBByMa(int ma){
            for(LoaiDV i:l2)
                if(i.getMa()==ma)
                    return i;
    ...
    private KhachHang getPVByMa(int ma){
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            HoaDon ql=new HoaDon(getPVByMa(ma1),getKBByMa(ma2), sl,tien);
