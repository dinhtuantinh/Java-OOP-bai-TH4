...
public class Main extends javax.swing.JFrame {
    ...
    public Main() {
        initComponents();
        setSize(1000,550);
        jTabbedPane1.add(new FormKhachHang(),"Thong tin khach hang");
        jTabbedPane1.add(new FormPhong(),"Thong tin phong");
        jTabbedPane1.add(new FormDSTP(),"Thong tin thue phong");
        jTabbedPane1.add(new FormTK(),"Thong ke");
    }
