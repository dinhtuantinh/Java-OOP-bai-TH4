...
public class FormKH extends javax.swing.JPanel {
    ...
    public FormKH() {
        initComponents();
        setSize(950,850);
        String[] cols={"Ma khach hang","Ten khach hang","Kieu khach hang"};
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Kieu khach hang");
    ...
    private void btCapNhatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCapNhatActionPerformed
        ...
        if(them){
            ...
            try{
               ...
               KhachHang s=new KhachHang(ma,ten,jComboBox1.getSelectedItem().toString());
        ...
        if(sua){
            ...
            KhachHang s=new KhachHang(ma, ten, kieu);
    ...
    private void btThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btThemActionPerformed
        ...
        buttonSate(false);
        them=true;
        if(lkh!=null && lkh.size()>0)
            KhachHang.setSma(lkh.get(lkh.size()-1).getMa()+1);
        else
            lkh=new ArrayList<>();
