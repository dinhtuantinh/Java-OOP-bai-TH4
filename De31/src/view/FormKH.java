...
public class FormKH extends javax.swing.JPanel {
    ...
    public FormKH() {
        initComponents();
        setSize(950,850);
        String[] cols={"Ma KH","Ten KH","Loai xe can thue","So xe can"};
        tm=new DefaultTableModel(cols, 0);
        jTable1.setModel(tm);
        buttonSate(true);
        them=false;
        sua=false;
        f="src/controller/KH.dat";
        loadData();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Loai xecan thue");

        jLabel4.setText("So xe can thue");
    ...
    private void btCapNhatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCapNhatActionPerformed
        ...
        if(them){
            ...
            try{
               ...
               sxe=jTextField4.getText();
               if(ten.isEmpty()||loai.isEmpty()||sxe.isEmpty()) throw new TrongException();
               int ma=Integer.parseInt(jTextField1.getText());
               int sl=Integer.parseInt(jTextField4.getText());
               KhachHang b=new KhachHang(ma,ten,loai,sl);
    ...
    private void btThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btThemActionPerformed
        ...
        them=true;
        if(l!=null && l.size()>0)
            KhachHang.setSma(l.get(l.size()-1).getMa()+1);
        else
            l=new ArrayList<>();
    ...
    private void btSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSuaActionPerformed
        ...
        if(row<0 || row>jTable1.getRowCount()-1)
            JOptionPane.showMessageDialog(this, "Chon kh de sua");
        else{
            sua=true;
            buttonSate(false);
            jTextField2.requestFocus();
    ...
    private void btXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btXoaActionPerformed
        ...
        int row=jTable1.getSelectedRow();
        if(row<0 && row>jTable1.getRowCount()-1)
            JOptionPane.showMessageDialog(this, "Chon kh de xoa");
        else{
            tm.removeRow(row);
            l.remove(row);
        }
