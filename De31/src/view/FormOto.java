 ...
 * @author Admin
 */
public class FormOto extends javax.swing.JPanel {
    ...
    public FormOto() {
        initComponents();
        setSize(950,850);
        String[] cols={"Ma Xe","Khie xe","Muc thue","So xe"};
        tm=new DefaultTableModel(cols, 0);
        jTable1.setModel(tm);
        buttonSate(true);
        them=false;
        sua=false;
        f="src/controller/OTO.dat";
        loadData();
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Kieu xe");

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "xe 4 cho loai thuong", "xe 4 cho loai cao cap", "xe 7 cho", "xe tai" }));
    ...
    private void btCapNhatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCapNhatActionPerformed
        ...
        if(them){
            String muc, soxe;
            try{
               muc=jTextField2.getText();
               soxe=jTextField3.getText();
               if(muc.isEmpty()|| soxe.isEmpty()) throw new TrongException();
               ...
               Oto s=new Oto(ma,jComboBox1.getSelectedItem().toString(),m,sl);
        ...
        if(sua){
            ...
            int m=Integer.parseInt(tm.getValueAt(row, 2).toString());
            ...
            Oto s=new Oto(ma,loai,m,sl);
            tm.setValueAt(ma, row, 0);
            tm.setValueAt(loai, row, 1);
            tm.setValueAt(m, row, 2);
    ...
    private void btThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btThemActionPerformed
        ...
        them=true;
        if(l!=null && l.size()>0)
            Oto.setSma(l.get(l.size()-1).getMa()+1);
        else
            l=new ArrayList<>();
    ...
    private void btSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSuaActionPerformed
        ...
        if(row<0 || row>jTable1.getRowCount()-1)
            JOptionPane.showMessageDialog(this, "Chon oto de sua");
        else{
            sua=true;
            buttonSate(false);
            jTextField2.requestFocus();
    ...
    private void btXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btXoaActionPerformed
        ...
        int row=jTable1.getSelectedRow();
        if(row<0 || row>jTable1.getRowCount()-1)
            JOptionPane.showMessageDialog(this, "Chon oto de xoa");
        else{
            tm.removeRow(row);
            l.remove(row);
        }
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if(row<0 || row>jTable1.getRowCount()-1)
            ...
            String kieu=tm.getValueAt(row,1).toString();
            jTextField2.setText(tm.getValueAt(row,2).toString());
