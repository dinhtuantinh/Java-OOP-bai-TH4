 ...
 * @author Admin
 */
public class FormHK extends javax.swing.JPanel {

    DefaultTableModel tm;
    private boolean them,sua;
    private String f;
    private List<HanhKhach> l;
    //private List<Phong> l2;
    public FormHK() {
        initComponents();
        setSize(950,850);
        String[] cols={"Ma HK","Ten HK","Dia chi","Loai khach"};
        tm=new DefaultTableModel(cols, 0);
        jTable1.setModel(tm);
        buttonSate(true);
        them=false;
        sua=false;
        f="src/controller/HK.dat";
        loadData();
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Loai khach");

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "học sinh sinh viên", "cán bộ trong ngành", "khách thông thường" }));
    ...
    private void btCapNhatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCapNhatActionPerformed
        ...
        if(them){
            ...
            try{
               ...
               HanhKhach b=new HanhKhach(ma,ten,dc,jComboBox1.getSelectedItem().toString());
        ...
        if(sua){
            ...
            int ma=Integer.parseInt(jTextField1.getText());
            HanhKhach b=new HanhKhach(ma, ten, dc, loai);
    ...
    private void btThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btThemActionPerformed
        ...
        them=true;
        if(l!=null && l.size()>0)
            HanhKhach.setSma(l.get(l.size()-1).getMa()+1);
        else
            l=new ArrayList<>();
        jTextField1.setText(HanhKhach.getSma()+"");
        jTextField2.requestFocus();
    ...
    private void btSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSuaActionPerformed
        ...
        if(row<0 || row>jTable1.getRowCount()-1)
            JOptionPane.showMessageDialog(this, "Chon hk de sua");
        else{
            sua=true;
            buttonSate(false);
            jTextField2.requestFocus();
    ...
    private void btXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btXoaActionPerformed
        ...
        int row=jTable1.getSelectedRow();
        if(row<0 && row>jTable1.getRowCount()-1)
            JOptionPane.showMessageDialog(this, "Chon hk de xoa");
        else{
            tm.removeRow(row);
            l.remove(row);
        }
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if(row>=0 && row<jTable1.getRowCount()){
            ...
            String loai=tm.getValueAt(row,3).toString();
