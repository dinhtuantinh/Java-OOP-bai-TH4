...
public class FormMon extends javax.swing.JPanel {
    ...
    public FormMon() {
        initComponents();
        setSize(950,850);
        String[] cols={"Ma mon","Ten","Tong so tiet","Loai mon"};
    ...
    private void btCapNhatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCapNhatActionPerformed
        ...
        if(them){
            ...
            try{
               ...
               if(ten.isEmpty()|| st.isEmpty()) throw new TrongException();
               int tiet=Integer.parseInt(jTextField3.getText());
               
               int ma=Integer.parseInt(jTextField1.getText());
               MonHoc s=new MonHoc(ma,ten,tiet,jComboBox1.getSelectedItem().toString());
        ...
        if(sua){
            ...
            MonHoc s=new MonHoc(ma,ten,tiet,loai);
