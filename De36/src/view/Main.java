...
public class Main extends javax.swing.JFrame {
    ...
    public Main() {
        initComponents();
        setSize(1000,550);
        jTabbedPane1.add(new FormNguoiMua(), "Thong tin nguoi mua ve");
        jTabbedPane1.add(new FormLoaiVe(), "Thong tin ve may bay");
        jTabbedPane1.add(new FormHoaDon(), "Thong tin hoa don");
    }
